...
def list_database():
        mydb=mysql.connector.connect(host="localhost",user="root",passwd=" ",database="stock",charset="utf8")   					#change as per system
        mycursor=mydb.cursor()
        sql="show tables;"
        mycursor.execute(sql)
        for i in mycursor:
...
def update_product():
           mydb=mysql.connector.connect(host="localhost",user="root",passwd=" ",database="stock",charset="utf8")
           mycursor=mydb.cursor()
